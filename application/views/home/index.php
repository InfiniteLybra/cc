<section class="site-hero overlay" style="background-image: url(<?= base_url(); ?>/assets/images/hero_4.jpg)" data-stellar-background-ratio="0.5">
  <div class="container">
  ...
  <div class="container">
    <div class="row check-availabilty" id="next">
      <div class="block-32" data-aos="fade-up" data-aos-offset="-200">
        ...
        <form action="<?= base_url('Reservation/availability') ?>" method="post">
          <div class="row">
            <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
              <label for="checkin_date" class="font-weight-bold text-black">Check In</label>
              <div class="field-icon-wrap">
                <div class="icon"><span class="icon-calendar"></span></div>
                <input type="text" id="checkin_date" name="check_in" class="form-control" autocomplete="off" required>
              </div>
            </div>
            <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
              ...
              <div class="field-icon-wrap">
                <div class="icon"><span class="icon-calendar"></span></div>
                <input type="text" id="checkout_date" name="check_out" class="form-control" autocomplete="off" required>
              </div>
            </div>
    ...
    <div class="row align-items-center">
      <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
        <figure class="img-absolute">
          <img src="<?= base_url(); ?>/assets/images/food-1.jpg" alt="Image" class="img-fluid">
        </figure>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <a href="" class="room">
          <figure class="img-wrap">
            <img src="<?= base_url(); ?>/assets/images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
          </figure>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <a href="" class="room">
          <figure class="img-wrap">
            <img src="<?= base_url(); ?>/assets/images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
          </figure>
          <div class="p-3 text-center room-info">
            <h2>Family Room</h2>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <a href="" class="room">
          <figure class="img-wrap">
            <img src="<?= base_url(); ?>/assets/images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
          </figure>
          <div class="p-3 text-center room-info">
      ...
      <div class="col-md-12">
        <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-1.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-1.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-2.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-2.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-3.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-3.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-4.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-4.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-5.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-5.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-6.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-6.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
          <div class="slider-item">
            <a href="<?= base_url(); ?>/assets/images/slider-7.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="<?= base_url(); ?>/assets/images/slider-7.jpg" alt="Image placeholder" class="img-fluid"></a>
          </div>
        </div>
        <!-- END slider -->
      </div>
...
<section class="section bg-image overlay" style="background-image: url('<?= base_url(); ?>/assets/images/hero_3.jpg');">
  <div class="container">
    <div class="row justify-content-center text-center mb-5">
      <div class="col-md-7">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
        <div class="media media-custom d-block mb-4 h-100">
          <a href="" class="room">
            <a href="" class="mb-4 d-block"><img src="<?= base_url(); ?>/assets/images/img_1.jpg" alt="Image placeholder" class="img-fluid"></a>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
        <div class="media media-custom d-block mb-4 h-100">
          <a href="" class="room">
            <a href="" class="mb-4 d-block"><img src="<?= base_url(); ?>/assets/images/img_2.jpg" alt="Image placeholder" class="img-fluid"></a>
            <div class="media-body">
              <span class="meta-post">February 26, 2018</span>
              <a href="" class="room">
                <h2 class="mt-0 mb-3"><a href="">5 Job Types That Allow You To Earn As You Travel The World</a></h2>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
        <div class="media media-custom d-block mb-4 h-100">
          <a href="" class="room">
            <a href="" class="mb-4 d-block"><img src="<?= base_url(); ?>/assets/images/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
            <div class="media-body">
              <span class="meta-post">February 26, 2018</span>
              <a href="" class="room">
