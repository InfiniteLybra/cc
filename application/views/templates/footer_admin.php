        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by Softboy 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	...
	<script src="<?= base_url(); ?>/asset/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
	
	<!-- Apex Chart -->
	<script src="<?= base_url(); ?>/asset/vendor/apexchart/apexchart.js"></script>
	...
	<!-- Dashboard 1 -->
	<script src="<?= base_url(); ?>/asset/js/dashboard/dashboard-1.js"></script>
	
	<script src="<?= base_url(); ?>/asset/vendor/owl-carousel/owl.carousel.js"></script>
