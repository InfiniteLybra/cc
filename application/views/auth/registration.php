                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="post" action="<?= base_url('auth/registration'); ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="fullname1" name="fullname1" value="<?= set_value('fullname1'); ?>" autocomplete="off" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="mb-1"><strong>Email</strong></label>
                                            <input type="email" class="form-control" id="email1" name="email1" value="<?= set_value('email1'); ?>" autocomplete="off" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="mb-1"><strong>Username</strong></label>
                                            <input type="text" class="form-control"  id="username1" name="username1" value="<?= set_value('username1'); ?>" autocomplete="off" required>
                                        </div>
                                        <div class="mb-3">
