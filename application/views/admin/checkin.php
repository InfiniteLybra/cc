    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Check In</a></li>
            </ol>
        </div>
        <!-- row -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Check In Queue</h4>
                    </div>
                    <div class="card-body">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <?php foreach ($room as $r) : ?>
                                                            <?php if ($r['status'] == 'Available') : ?>
                                                                <a class="dropdown-item" href="<?= base_url('Admin/insertroom'); ?>/<?= $r['room']; ?>/<?= $b['name']; ?>"><?= $r['room']; ?></a>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    </div>
                                                </div> -->
